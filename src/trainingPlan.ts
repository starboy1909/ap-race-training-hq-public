...
export function buildPlan(choice: MarathonChoice='none'): Week[] {
 ...
 for(let n=0;n<39;n++){
  ...
  for(let dow=0;dow<7;dow++){
   ...
   if(iso==='2026-09-16')spec={title:'Recovery reset · easy or rest',type:'RECOVERY',duration:'0–40 min',rpe:'0–3',note:'The planned threshold session is replaced after Tuesday’s longer, faster-than-prescribed 10.05 km. Resume quality only after normal walking, stairs and next-morning symptoms.',blocks:[block('RECOVERY GATE',['Preferred: rest, or 30–40 min very easy at 6:20–7:10/km only if legs feel normal and breathing stays conversational. An easy bike at RPE 2–3 is the non-impact option.','No intervals, strides, lower-body strength or make-up work. Thursday upper body remains available; Friday HYROX proceeds only if recovery is normal.'])]};
