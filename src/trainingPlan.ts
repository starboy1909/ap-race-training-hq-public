...
export const planReviewed = '2026-09-15';
...
export function buildPlan(choice: MarathonChoice='none'): Week[] {
 ...
 for(let n=0;n<39;n++){
  ...
  for(let dow=0;dow<7;dow++){
   ...
   if(iso==='2026-09-15')spec={title:'Completed 10.05 km · Garmin verified',type:'QUALITY',duration:'58:51',rpe:'Recorded load',note:'Garmin verified 15 September: 10.05 km in 58:51 (approximately 5:51/km), average heart rate 155. This exceeded the planned 8 km easy dose and landed in the steady range; no added conditioning today.',blocks:[block('COMPLETED SESSION',['10.05 km recorded on Garmin. Treat this as the week’s sustained running load, not an easy-day completion.','Recover with normal meals, fluids and sleep. No make-up kilometres or second leg session.'])]};
